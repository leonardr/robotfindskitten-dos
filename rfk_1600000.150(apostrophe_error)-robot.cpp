...
static char* messages[] =
{
	...
	"A shameless plug for Nerth Pork: http://www.northpark.edu/~ppeters/nerth_pork/",
	"A can of Spam Lite.",
	...
	"A historical marker showing the actual location of /dev/nul.",
	"Thars Mobius Dick, the convoluted whale. Arrr!"
};
...
int main(int argc, char *argv[])
{
	...
	if (argc == 1)
	{
	 ...
	 {
	  cout << "Error: run-time parameter must be between 0 and " << MESSAGES << ".";
	  exit(0);
	 } else {
